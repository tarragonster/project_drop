                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                  <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
                                    	<img src="<?php echo isset($account['avatar']) && $account['avatar'] != '' ? base_url($account['avatar']) : base_url('media/managers/avatar.jpg');?>" alt="user-img" class="img-circle"> </a>
                    	...
                    	<ul>
							...
							<li class="has_sub">                             
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li <?php echo ($sub_id == 22 ? 'class="active"' : '');?>><a href="<?php echo base_url('admin/user/blocked');?>">Blocked Users</a>
                                    </li>   
                            ...
                            <li>
                               <a href="<?php echo base_url('admin/collection');?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 4 ? ' active' : '';?>"><i class="fa fa-industry"></i> <span>Collections</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                               <a href="<?php echo base_url('admin/comment');?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 9 ? ' active' : '';?>"><i class="ti-comment"></i> <span>Comments</span></a>
                            </li>
                            <li>
