				...
				<ul>
					<li>
						<a href="<?php echo base_url(''); ?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 1 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 1) { ?>
                                <img src= "assets/images/left-sidebar/Dashboard-active.svg" alt="Dashboard">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/dashboard.svg" alt="Dashboard">
                            <?php } ?>
					...
					<li class="has_sub">
						<a href="#" class="waves-effect<?php echo isset($parent_id) && $parent_id == 2 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 2) { ?>
                                <img src= "assets/images/left-sidebar/User-active.svg" alt="Users">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/User.svg" alt="User">
                            <?php } ?>
                            <span>Users</span> </a>
					...
					<li>
						<a href="<?php echo base_url('product'); ?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 3 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 3) { ?>
                                <img src= "assets/images/left-sidebar/stories-active.svg" alt="Dashboard">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/stories.svg" alt="Stories">
                            <?php } ?>
                            <span>Stories</span></a>
					</li>
					<li>
						<a href="<?php echo base_url('preview'); ?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 10 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 10) { ?>
                                <img src= "assets/images/left-sidebar/Explore-active.svg" alt="Explore">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/Explore.svg" alt="Explore">
                            <?php } ?>
                            <span>Explore</span></a>
					</li>
					<li>
						<a href="<?php echo base_url('collection'); ?>" class="waves-effect<?php echo isset($parent_id) && $parent_id == 4 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 4) { ?>
                                <img src= "assets/images/left-sidebar/Collections-active.svg" alt="Collections">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/Collections.svg" alt="Collections">
                            <?php } ?>
					...
					<li class="has_sub">
						<a href="#" class="waves-effect<?php echo isset($parent_id) && $parent_id == 9 ? ' active' : ''; ?>">
                            <?php if (isset($parent_id) && $parent_id == 9) { ?>
                                <img src= "assets/images/left-sidebar/Comments-active.svg" alt="Comments">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/Comments.svg" alt="Comments">
                            <?php } ?>
                    ...
                    <li>
                        <a href="<?php echo base_url('logout'); ?>" class="waves-effect">
                            <?php if (isset($parent_id) && $parent_id == 1) { ?>
                                <img src= "assets/images/left-sidebar/Logout-active.svg" alt="Logout">
                            <?php }else{ ?>
                                <img src= "assets/images/left-sidebar/Logout.svg" alt="Logout">
                            <?php } ?>
                            <span>Log Out</span></a>
                    </li>
				</ul>
