...
<div class="outer-text-dis">
    ...
    <div class="detail-dis">Are you sure you want to delete this user?
...
<div class="outer-btn">
    ...
    <button class="btn-confirm" style="background: #E62C30;" onclick="ShowSecondDeleteReported()">Delete</button>
</div>