<div class="row">
    ...
    <div class="col-xs-12">
        <h3 class="m-t-0 m-b-20 header-title">Actor <?php echo $name ?></h3>
    </div>
</div>
						...
						<div class="col-md-6 card-box">
							...
							<div class="box-body">
								<div class="form-group">                       
									<label>Name</label>                        
			                        <input id="nameActor" type="text" name='name' value="<?php echo $name;?>"  required class="form-control" placeholder="" />
								</div>
								<div class="form-group">                       
									<label>From</label>                        
			                        <input type="text" name='country' value="<?php echo $country;?>"  required class="form-control" placeholder=""/>
								...
								<div class="form-group">                       
									...
									<div id="descriptionActor">
										<textarea  name="description" class="form-control" placeholder="" rows="3" required=""><?php echo $description;?></textarea>	
									</div>
								...
								<div class="form-group" style='margin-top:10px'>
									...
									<div class="input-group m-t-10">
										...
										<input id="facebook" type="text" name="facebook_link" class="form-control" placeholder="Facebook link" value="<?php echo $facebook_link;?>" >
                        ...
                        <table id="example3" class="table table-bordered table-hover">
                            ...
                            if ($products != null && count($products) > 0) {
                                foreach ($products as $row) {
                                    ...
                                    echo "<a href='" . base_url('admin/actor/removeProduct/' . $row['product_id'].'/'.$cast_id) . "' /><button class='btn btn-danger btn-custom btn-xs'>Remove</button></a>";
                                    echo "</div></td>";
                                    echo '</tr>';
                                }
                            }
