...
<ul class="nav nav-tabs">
	<li <?= $active == 'list' ? 'class="active"' : '' ?>>
		<a data-toggle="tab" href="#list">List Films</a>
	</li>
	<li <?= $active == 'add' ? 'class="active"' : '' ?>>
		<a data-toggle="tab" href="#add">Add film</a>
	</li>
</ul>
						...
						<table id="example3" class="table table-striped table-bordered table-hover">
							...
							if ($others != null && count($others) > 0) {
								foreach ($others as $row) { ?>
									...
									<td>
										<div class='button-list'>
											<a href="<?php echo base_url('admin/collection/addFilm/' . $row['product_id'] . '/' . $collection_id) ?>">
