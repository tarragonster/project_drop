<div class="header-genre">
	<div class="row">
		...
		<div class="col-sm-2 col-lg-2">
			<div class="title-header">Preview Activity</div>
		</div>
		<div class="col-sm-2 col-lg-2">
			<div class="title-header">Date Added to Preview List</div>
		</div>
...
<div class="card-box explore-mess-box">
	<span>Click <b>Add Story</b> to add a user to the Explore Preview List</span>
</div>
