    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="card-box table-responsive">
                ...
                <div class="box-header">
                    <a href="<?php echo base_url('admin/actor/add') ?>">
                    ...
                    <table id="example3" class="table table-bordered table-hover">
                        ...
                        if ($actors != null && count($actors) > 0) {
                            foreach ($actors as $row) {
                                ...
                                echo "<a href='" . base_url('admin/actor/edit/' . $row['cast_id']) . "' /><button class='btn btn-inverse btn-custom btn-xs'>Edit</button></a>";
                                echo '<span class="sa-warning" data-href="' . base_url('admin/actor/delete/' . $row['cast_id']) . '"><button class="btn btn-danger btn-custom btn-xs">Delete</button></span>';
                                echo "</div></td>";
                                echo '</tr>';
                            }
                        }
