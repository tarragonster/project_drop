                    ...
                    <table id="example3" class="table table-bordered table-hover">
                        ...
                        if ($actors != null && count($actors) > 0) {
                            foreach ($actors as $row) {
                                ...
                                echo "<a href='" . base_url('admin/product/removeActor/' . $row['cast_id'].'/'.$product_id) . "' /><button class='btn btn-danger btn-custom btn-xs'>Remove</button></a>";
                                echo "</div></td>";
                                echo '</tr>';
                            }
                        }
                        ...
                        <table id="example3" class="table table-bordered table-hover">
                            ...
                            if ($others != null && count($others) > 0) {
                                foreach ($others as $row) {
                                    ...
                                    echo '<td>' . $row['country'] . '</td>';
                                    echo "<td><div class='button-list'>";
                                    echo "<a href='" . base_url('admin/product/addActor/' . $row['cast_id'].'/'.$product_id) . "' /><button class='btn btn-inverse btn-custom btn-xs'>Add</button></a>";
                                    echo "</div></td>";
                                    echo '</tr>';
                                }
                            }
