<div class="table-responsive " style="width: 100%; border: 0;overflow: unset;">
	<table class="table dataTable preview_table">
		...
		<tr class="display-flex">
			...
			<th class="flex-item">Trending Activity</th>
			<th class="flex-item">Date Added to Trending</th>
		...
		<tr><td colspan="8">
				<form action="" method="post" id="form-data">
					<ul data-url="<?= base_url('collection/sortable/1')?>" class="sortable">
						<input type="hidden" name="dragging" value="0"/>
						<?php foreach ($trending_products as $key => $row):?>
							<li id="user_<?php echo $row['product_id']; ?>" data-id="<?php echo $row['product_id']; ?>">
								...
								<div class="card-box card-sorting row">
									...
									<div class="col-sm-3 col-lg-2 sortable-box width-13" style="padding: 0px;width: 80px">
										<?php echo image_mask(media_thumbnail($row['promo_image'], 53), 'assets/images/trending_mark.png', 37, 'border-radius:5px')?>
									</div>
	...
	<div class="modal-dialog modal-carousel">
		<div class="modal-content modal-content-popup">
			...
			<div class="modal-description">
				<h2>Are you sure?</h2>
				<p>Are you sure you want to disable this story from the trending section? You will be able to undo this in the actions section.</p>
			</div>
...
<div class="modal fade" id="en-modal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-carousel">
		<div class="modal-content modal-content-popup">
			...
			<div class="modal-description">
				<h2>Are you sure?</h2>
				<p>Are you sure you want to enable this this story from the trending section? You will be able to undo this in the actions section.</p>
			</div>
			<div class="modal-button">
				<button type="button" class="btn btn-secondary cancel-btn" data-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="del-modal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-carousel">
		<div class="modal-content modal-content-popup">
			...
			<div class="modal-description">
				<h2>Are you sure?</h2>
				<p>Are you sure you want to remove this this story from the trending section? You will not be able to undo this.</p>
			</div>
			<div class="modal-button">
				<button type="button" class="btn btn-secondary cancel-btn" data-dismiss="modal">Cancel</button>
