...
<div class="modal custom-modal below-header fade visiting right" id="add-carousel-popup" tabindex="-1" role="dialog">
	<form action="<?php echo base_url('collection/addToCollection/5')?>" method="post" id="story-form-add" enctype="multipart/form-data">
