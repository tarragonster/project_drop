		...
		<div class="box">
			<div class="card-box table-responsive">
				<div class="box-header">
					<h3 class="box-title">Reported Comments</h3>
				</div>
				<table id="example3" class="table table-bordered table-hover">
					...
					if (isset($reports) && is_array($reports)) {
						foreach ($reports as $row) {
							...
							echo "<a href='" . base_url('admin/comment/deleteReport/' . $row['report_id'] . '?redirect=' . uri_string()) . "' /><button class='btn btn-danger btn-sm'>Delete</button></a>";
							echo '</div></td>';
							echo '</tr>';
						}
					}
