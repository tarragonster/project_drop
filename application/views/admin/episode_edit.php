    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box-header">
                <h3 class="m-t-0 m-b-30 header-title">Edit Episode</h3>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row box-body">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input type="text" name='name' value="<?php echo $name;?>" class="form-control" required="" placeholder="Name" />
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Seasone Name" value="<?php echo $season_name;?>"  disabled/>
                    </div>
                </div>
                <div class="col-md-12">
