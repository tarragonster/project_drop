<table id="example3" class="table table-bordered-bottom" data-alert="Are you want to delete this product?">
	<thead>
		<tr><hr>
			<th></th>
			<th>Film ID</th>
		...
		if ($products != null && count($products) > 0) {
			foreach ($products as $row): ?>
              <tr>
                 ...
                 <td><?php echo ($row['paywall_episode_id'] == null)? 'N/a' : 'B' . $row['paywall_episode_id'] . ' - ' . $row['paywall_episode_name'] ?></td>
